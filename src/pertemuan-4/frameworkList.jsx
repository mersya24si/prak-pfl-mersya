  ...
  return (
    <div className="p-8 bg-pink-50 min-h-screen">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-black text-pink-600 mb-2">Explore Frameworks</h1>
        <p className="text-gray-500 font-medium">Modern tools for modern developers.</p>
      </div>
          ...
          >
            <div>
              ...
              <div className="flex justify-between items-start mb-4">
                <h2 className="text-3xl font-black text-pink-700">{item.name}</h2>
            ...
            <div>
              ...
              <div className="flex justify-between items-center">
                <div className="text-xs">
                  <p className="text-pink-300 font-bold uppercase tracking-tighter mb-0.5 text-[10px]">Developed By</p>
                  <p className="text-pink-600 font-black text-sm leading-none">{item.details.developer}</p>
                </div>
